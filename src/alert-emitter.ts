/**
 * Alert emitter: the glue between a raw PumpAlert and the outputs
...
import type { PumpAlert } from './detector';
...
export interface AlertEmitterOptions {
  ...
  /** Build the Telegram message text from alert + tradeUrl. */
